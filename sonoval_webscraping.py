...
session = HTMLSession() 
# index to search for emails. it still picks up some data tags or long strings starting with // which can be easily filtered out later, but I forgot to add that
